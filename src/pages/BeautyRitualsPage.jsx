      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-20">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20 lg:mb-32">
          <p className="font-display text-base lg:text-lg leading-relaxed mb-4" style={{ fontWeight: '300' }}>
            Un sanctuar de frumusețe și îngrijire personală unde ritualurile antice întâlnesc estetica modernă.
          </p>
          <p className="font-display text-base lg:text-lg leading-relaxed" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            Tratamente transformatoare care onorează esența ta naturală și amplifică radianta interioară.
          </p>
        </div>

        {/* Section 2: Hero image */}
        <div className="relative mb-20 lg:mb-32">
          <div className="relative h-[400px] lg:h-[450px] overflow-hidden rounded-lg">
            <img
        ...
        {/* Section 3: Image grid with different sizes */}
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-7 relative h-[350px] lg:h-[400px] overflow-hidden rounded-lg">
            <img
          ...
          <div className="lg:col-span-5 relative h-[350px] lg:h-[400px] overflow-hidden rounded-lg">
            <img
        ...
        <div className="relative mb-20 lg:mb-32">
          <div className="max-w-4xl mx-auto text-center relative py-12">
            ...
            >
              Frumusețe care onorează esența ta naturală
            </p>
          </div>
        </div>
