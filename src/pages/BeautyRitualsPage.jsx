...
export default function BeautyRitualsPage() {
  const colors = {
    goldPrimary: '#edcd67',
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="text-center mb-12">
          ...
          >
            Ritualuri de îngrijire conștientă
          </p>
        </div>
        ...
        <div ref={ref1} className={`max-w-4xl mx-auto text-center mb-20 lg:mb-32 animate-on-scroll ${isVisible1 ? 'visible' : ''}`}>
          <p className="font-display text-lg lg:text-xl leading-relaxed mb-6" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            Camera de Beauty este un sanctuar al feminității, al blândeții și al rafinamentului.
            Locul este gândit ca un moment de pauză sacră, în care corpul primește atenție, timp și prezență.
          </p>
          <p className="font-display text-lg lg:text-xl leading-relaxed" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            Aici, ritualurile de beauty nu sunt grăbite, sunt în ritmul tău iar produsele sunt alese cu respect față de tine.
          </p>
        </div>
        ...
        >
          ...
          >
            Camera de Beauty – Ritualuri de îngrijire conștientă
          </h2>
          ...
          <ul className="space-y-4 mb-8">
            {[
              "relaxare și revitalizare",
              "ritualuri faciale și corporale",
              "momente de liniște, respirație și integrare",
              "atmosferă premium, intimă și protectoare"
            ].map((benefit, index) => (
              <li
                key={index}
          ...
          <p
            ...
            style={{ color: colors.goldSecondary, fontWeight: '300' }}
          >
            Beauty devine o formă de auto-îngrijire profundă, nu o obligație.
          </p>
        </div>

        {/* Section 4: Image grid with different sizes */}
        <div ref={ref4} className={`grid lg:grid-cols-12 gap-6 lg:gap-8 mb-20 lg:mb-32 animate-on-scroll ${isVisible4 ? 'visible' : ''}`}>
          <div className="lg:col-span-7 relative h-[350px] lg:h-[550px] overflow-hidden rounded-3xl">
            <img
              src="/images/new/beauty2.webp"
          ...
          <div className="lg:col-span-5 relative h-[350px] lg:h-[550px] overflow-hidden rounded-3xl">
            <img
              src="/images/new/beauty3.webp"
              alt="Beauty Space"
              className="w-full h-full object-cover"
            />
            <div
        ...
        {/* Section 5: The Body Altar Experience */}
        <div ref={ref5} className={`max-w-5xl mx-auto mb-20 lg:mb-32 animate-on-scroll ${isVisible5 ? 'visible' : ''}`}>
          <h2
            ...
            style={{ color: colors.goldPrimary, textShadow: '0 2px 8px rgba(0, 0, 0, 0.2)', fontWeight: '300' }}
          >
            Experiența The Body Altar
          </h2>

          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {[
              "Spațiu intim, elegant și sacru",
              "auto îngrijire în liniște",
              "Ritm lent, fără presiune",
              "Îngrijire care susține corpul, emoția și energia"
            ].map((item, index) => (
          ...
          <p
            ...
            style={{ color: colors.goldSecondary, fontWeight: '300' }}
          >
            The Body Altar este locul unde corpul nu este corectat, ci onorat.
          </p>
        </div>
