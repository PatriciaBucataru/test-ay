      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        <div ref={ref1} className={`max-w-4xl mx-auto text-center mb-20 lg:mb-32 animate-on-scroll ${isVisible1 ? 'visible' : ''}`}>
          <p className="font-display text-lg lg:text-xl leading-relaxed mb-6" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            The Breath Chamber este spațiul în care respirația devine medicină.
            Un loc profund și protejat, dedicat reglării interioare, eliberării emoționale și reconectării cu esența ta.
          </p>
          <p className="font-display text-lg lg:text-xl leading-relaxed mb-6" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            Aici nu „faci" nimic.
            Aici permiți.
          ...
          <p className="font-display text-lg lg:text-xl leading-relaxed" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            Respirația conștientă deschide uși subtile: în corp, în emoții, în memorie. Fără forțare. Fără grabă. Doar adevăr, prezență și siguranță.
          </p>
        </div>

        {/* Section 2: Statement */}
        <div ref={ref2} className={`max-w-4xl mx-auto text-center mb-20 lg:mb-32 animate-on-scroll ${isVisible2 ? 'visible' : ''}`}>
          <p className="font-display text-lg lg:text-xl leading-relaxed" style={{ color: colors.goldSecondary, fontWeight: '300' }}>
            The Breath Chamber este creat pentru a susține procese profunde, într-un cadru calm, elegant și ghidat cu responsabilitate.
          </p>
        </div>

        {/* Section 3: Large hero image */}
        <div ref={ref3} className={`relative mb-20 lg:mb-32 animate-on-scroll ${isVisible3 ? 'visible' : ''}`}>
          <div className="relative h-[400px] lg:h-[600px] overflow-hidden rounded-3xl">
            <img
              src="/images/new/breath4.webp"
              alt="The Breath Chamber"
        ...
        >
          ...
          >
            Breathwork – Puterea respirației conștiente
          </h2>
          <p
            className="font-display text-lg lg:text-xl leading-relaxed mb-8"
            style={{ color: colors.goldSecondary, fontWeight: '300' }}
          >
            Respirația este cel mai direct canal către sistemul nervos și starea de echilibru interior.
            Prin tehnici ghidate de breathwork, corpul este invitat să elibereze tensiuni vechi, mintea să se liniștească, iar energia să curgă din nou liber.
          </p>
          ...
          <ul className="space-y-4 mb-8">
            {[
              ...
              "eliberarea stresului și a emoțiilor blocate",
              "claritate mentală și stare de calm profund",
              "reconectare cu corpul și intuiția"
            ].map((benefit, index) => (
              <li
                key={index}
          ...
          <p
            ...
            style={{ color: colors.goldSecondary, fontWeight: '300' }}
          >
            Respirația devine un ritual de întoarcere la tine.
          </p>
        </div>

        {/* Section 5: Image grid - 3 photos with different sizes */}
        <div ref={ref5} className={`grid lg:grid-cols-12 gap-6 lg:gap-8 mb-20 lg:mb-32 animate-on-scroll ${isVisible5 ? 'visible' : ''}`}>
          <div className="lg:col-span-7 relative h-[350px] lg:h-[550px] overflow-hidden rounded-3xl">
            <img
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
            <div className="relative h-[300px] lg:h-[265px] overflow-hidden rounded-3xl">
              <img
        ...
        <div className="max-w-5xl mx-auto mb-20 lg:mb-32">
          <h2
            ...
            style={{ color: colors.goldPrimary, textShadow: '0 2px 8px rgba(0, 0, 0, 0.2)', fontWeight: '300' }}
          >
            Experiența The Breath Chamber
          </h2>

          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {[
              "Sesiuni ghidate, într-un cadru sigur și susținător",
              "Ritm blând, adaptat fiecărei persoane",
              "Spațiu intim, sacru și liniștitor",
              "Integrare profundă între corp, respirație și emoție"
            ].map((text, index) => (
          ...
          <p
            ...
            style={{ color: colors.goldSecondary, fontWeight: '300' }}
          >
            The Breath Chamber este locul unde te oprești, te așezi și îți amintești cum este să fii.
          </p>
        </div>
        ...
        <div className="relative mb-20 lg:mb-32">
          <div className="max-w-4xl mx-auto text-center relative py-12">
            ...
            >
              Breathe. Release. Remember who you are.
            </p>
          </div>
        </div>
