...
export default function Footer() {
  return (
    <footer className="relative bg-[#6b7c5e] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid md:grid-cols-3 gap-12 lg:gap-16 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="font-body text-sm text-white/80 tracking-widest">
                  Manifest of Light
                </p>
              </div>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-lg font-light mb-4 tracking-wide text-white">
              Explorează
            </h4>
            <ul className="space-y-3 font-body text-sm">
              <li>
                <a href="#about" className="text-white/80 hover:text-[#f4d03f] transition-colors">
                  Despre AYA
                </a>
              </li>
              <li>
                <a href="#experiences" className="text-white/80 hover:text-[#f4d03f] transition-colors">
                  Experiențe
                </a>
              </li>
              <li>
                <a href="#" className="text-white/80 hover:text-[#f4d03f] transition-colors">
                  Program
                </a>
              </li>
              <li>
                <Link to="/contact" className="text-white/80 hover:text-[#f4d03f] transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-white/80">
              ...
              <li>
                <a href="tel:+40771444554" className="hover:text-[#f4d03f] transition-colors">
                  +40 771 444 554
                </a>
              </li>
              <li className="pt-2">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
              <p className="font-body">
                © {new Date().getFullYear()} House of Aya. All rights reserved.
              </p>
              <div className="flex gap-4">
                <Link to="/terms" className="hover:text-[#f4d03f] transition-colors">
                  Termeni și Condiții
                </Link>
                <span className="hidden md:inline">|</span>
                <Link to="/privacy" className="hover:text-[#f4d03f] transition-colors">
                  Politică de confidențialitate
                </Link>
              </div>
            </div>
            <p className="font-body italic">
              Created in Light | Guided by Soul
            </p>
          </div>
        </div>
      </div>
