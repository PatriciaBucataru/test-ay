...
export default async function handler(req, res) {
  ...
  try {
    ...
    await saveToBackup(rsvpData, 'event16');
    ...
    console.log(`✅ RSVP saved for Event 16: ${sanitizedNume} ${sanitizedPrenume}`);
    ...
    console.error('❌ Error submitting RSVP for Event 16:', {
      message: error.message,
