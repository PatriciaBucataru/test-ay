...
export default async function handler(req, res) {
  ...
  try {
    ...
    await saveToBackup(rsvpData, 'event15-en');
    ...
    const appendPromise = sheets.spreadsheets.values.append({
      ...
      range: 'Event 15 Ianuarie EN!A:D',
    ...
    console.log(`✅ RSVP saved for Event 15: ${sanitizedNume} ${sanitizedPrenume}`);
    ...
    console.error('❌ Error submitting RSVP for Event 15:', {
      message: error.message,
